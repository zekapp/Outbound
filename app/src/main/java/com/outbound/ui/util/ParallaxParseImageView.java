 ...
 */
public class ParallaxParseImageView extends ParseImageView implements SensorEventListener {
    ...
    public ParallaxParseImageView(Context context) {
        this(context, null);
    }

    public ParallaxParseImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ParallaxParseImageView(Context context, AttributeSet attrs, int defStyle) {
